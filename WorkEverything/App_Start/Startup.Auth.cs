...
using TranninShop.Data;
using TranninShop.Model.Models;

[assembly: OwinStartup(typeof(TranninShop.Web.App_Start.Startup))]

namespace TranninShop.Web.App_Start
{
	public partial class Startup
	{
		...
		public void ConfigureAuth(IAppBuilder app)
		{
			...
			app.CreatePerOwinContext(TranninShopDbContext.Create);
		...
		{
			var userStore = new UserStore<ApplicationUser>(context.Get<TranninShopDbContext>());
